<template>
    <div class="main">
        ...
        <div class="form-input-container-year">
            ...
            <input class="form-input-year" type="number" min="1900" :max="currentYear" step="1" v-model="cvStore.teachingYears.techingStartYear"
                id="start-teaching-year">
        </div>
        <div class="form-input-container-year">
            <label for="start-ucb-year" class="form-label">Año en el que empezó a dar clases en la UCB:</label>
            <input class="form-input-year" type="number" min="1900" :max="currentYear" step="1" v-model="cvStore.teachingYears.teachingUCBStartYear"
                id="start-ucb-year">
        </div>
